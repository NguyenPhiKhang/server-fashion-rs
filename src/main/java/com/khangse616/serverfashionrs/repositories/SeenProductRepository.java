...
//    int existsSeenProductByProductIdAndUserId();
    ...
    @Query(value = "SELECT * FROM fashionshop_db.seen_products where user_id = :id_userId and CURRENT_TIMESTAMP - last_time < 7000000 order by last_time desc", nativeQuery = true)
